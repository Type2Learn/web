(() => {
  ...
  const teamDeck = () => {
    const members = [
      ...
      ['Idrees Babar', 'Co-founder · Research lead', '/assets/team/idrees-babar.webp', 'Idrees Babar, research lead at Type2Learn', false, 'His role connects evidence review, research design, measurement quality, and honest public claims to the decisions made in the learning experience.', 'Evidence matters most when it changes what we build and what we are willing to claim.', ['Evidence review', 'Pilot design', 'Measurement quality']],
