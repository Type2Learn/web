(() => {
  ...
  const learningTogether = () => shell(
    ...
    '<section class="page-section learning-together-intro"><div class="content-wrap"><p class="section-kicker">Three perspectives, one respect standard</p><h2>Everyone should know what they can do—and what they should not be asked to do.</h2><p>These audiences were previously separate pages. Bringing them together makes the hand-offs explicit and removes repeated promises.</p><div class="audience-roles">' +
      '<article class="audience-role reveal"><div class="audience-icon">' + icon('keyboard') + '</div><span>01 · Learner</span><h3>Choose a clearer way in.</h3><p>See the objective, select the supports that help, and return to saved work calmly.</p><ul><li>Control presentation</li><li>Keep progress private by default</li><li>Build proof of learning</li></ul></article>' +
      '<article class="audience-role reveal" data-delay="1"><div class="audience-icon">' + icon('users') + '</div><span>02 · Family</span><h3>Support the routine, not constant monitoring.</h3><p>Use respectful questions and simple routines without being given a stream of private drafts.</p><ul><li>Understand the next review</li><li>Respect learner choices</li><li>Know when human help is needed</li></ul></article>' +
      '<article class="audience-role reveal" data-delay="2"><div class="audience-icon">' + icon('school') + '</div><span>03 · Educator or school</span><h3>Use evidence to teach.</h3><p>See the work and context required for a useful human decision—not behavioural or attention scores.</p><ul><li>Review academic evidence</li><li>Understand authorised supports</li><li>Keep a human override</li></ul></article>' +
    '</div></div></section>' +
  ...
  const participationRecord = [
    ['01', 'Professional perspective', '1 professional', 'Private notes and a consent-reviewed video record', 'The public page will show the topic, permission level, product decision, and follow-up—not a portrait or a personal profile.'],
    ['02', 'Teacher perspectives', '3 teachers', 'Text notes, classroom-practice prompts, and optional video links', 'Entries can show where lesson clarity, workflow, or reporting needs revision without identifying an individual teacher.'],
    ['03', 'Student perspectives', '5 students', 'A mix of text and audio only', 'No participant photos. Public material is limited to permissioned, de-identified learning insights and the decisions they affected.']
  ];

  const participationCards = () => participationRecord.map((entry, index) => '<article class="participation-card reveal" data-delay="' + index + '"><span class="participation-index">' + entry[0] + '</span><p class="section-kicker">' + entry[1] + '</p><h3>' + entry[2] + '</h3><p class="participation-format">' + icon(index === 2 ? 'headphones' : index === 1 ? 'school' : 'flask', true) + entry[3] + '</p><p>' + entry[4] + '</p><a href="#video-conversations">Evidence and video placement <span aria-hidden="true">↓</span></a></article>').join('');
  ...
  const urduLearningTogether = () => shell(
    ...
    '<section class="page-section learning-together-intro"><div class="content-wrap"><p class="section-kicker">تین زاویے، احترام کا ایک معیار</p><h2>ہر شخص کو معلوم ہونا چاہیے کہ وہ کیا کر سکتا ہے—اور اس سے کیا نہیں مانگا جانا چاہیے۔</h2><p>یہ معلومات پہلے الگ صفحات پر تھیں۔ ایک جگہ لانے سے ذمہ داریوں کا باہمی تعلق اور مشترکہ حدود واضح ہوتی ہیں۔</p><div class="audience-roles"><article class="audience-role reveal"><div class="audience-icon">' + icon('keyboard') + '</div><span>01 · سیکھنے والا</span><h3>اپنے لیے واضح راستہ منتخب کریں۔</h3><p>مقصد دیکھیں، مددگار کنٹرول منتخب کریں، اور پرسکون انداز میں محفوظ کام کی طرف واپس آئیں۔</p></article><article class="audience-role reveal" data-delay="1"><div class="audience-icon">' + icon('users') + '</div><span>02 · خاندان</span><h3>روٹین میں مدد کریں، مسلسل نگرانی نہیں۔</h3><p>نجی مسودوں کی فہرست کے بغیر احترام والی گفتگو اور مفید روٹین اپنائیں۔</p></article><article class="audience-role reveal" data-delay="2"><div class="audience-icon">' + icon('school') + '</div><span>03 · استاد یا اسکول</span><h3>تعلیم کے لیے ثبوت استعمال کریں۔</h3><p>انسانی فیصلے کے لیے ضروری کام اور تناظر دیکھیں، رویے یا توجہ کے اسکور نہیں۔</p></article></div></div></section>' +
