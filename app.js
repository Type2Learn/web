(() => {
  ...
  // Keep the public trust page aligned with the consent-aware server delivery
  // path. Analytics are optional measurement, never a pre-consent condition
  // of visiting the site or trying the local learning preview.
  const alignPublicClaims = (content) => String(content).replace(
    /This public site loads Cloudflare Web Analytics and Google Analytics \(measurement ID G-9ER1QJLGCW\) for site-use measurement; the local learning-demo response is not sent to either analytics tag\. Read the <a href="\/privacy\/">complete Privacy Policy<\/a> for the supplied publication draft and implementation requirements\./g,
    'Optional site analytics load only after a visitor accepts measurement in this browser. The local learning-demo response is not sent to analytics. Read the <a href="/privacy/">privacy-notice preview</a> for current boundaries and the legal review still required before launch.'
  );
  const shell = (content) => '<div class="site-shell">' + nav() + '<main id="main-content">' + alignPublicClaims(content) + siteCta() + nativeBuilderCredit + '</main>' + footer() + '</div>';
  ...
  const urduTeamDeck = () => {
    const members = [
      ['Muhammad Taha Bin Zaeem', 'بانی · ترقیاتی سربراہ', '/assets/team/founder-muhammad-taha.webp', 'Type2Learn کے بانی Muhammad Taha Bin Zaeem', 'supplied', 'وہ Type2Learn کے وژن، مصنوعات کی ترقی، شراکت داریوں اور ذمہ دار ترقی کی رہنمائی کرتے ہیں، اور سیکھنے کے تجربے کو ثبوت، رازداری، رسائی اور سیکھنے والے کے وقار کے واضح معیار سے جوڑتے ہیں۔', 'تعلیمی ٹیکنالوجی اگلا بامعنی قدم واضح کرے، سیکھنے والے کو چھوٹا محسوس نہ کرائے۔', ['وژن اور حکمتِ عملی', 'سیکھنے کا تجربہ', 'ذمہ دار ترقی']],
  ...
  const participationInterviewSection = () => {
    ...
    const interviews = isUrdu ? [
      ...
      ['01', copy.professional, 'Dr. Mayda', copy.position, 'dr-mayda-interview-spotlight.png', 'https://github.com/Type2Learn/Interviews/blob/main/Professionals/Pre-Product/Dr%20Mayda/readme.md', copy.transcript, ['Neurodiversity should be understood as variation in learning and communication—not as a deficit label.', 'A support should make meaningful work easier to enter without lowering what the learner can show.', 'Sensory, focus, and communication preferences need calm choices and a clear way back into the task.', 'There is no single helpful setting: some learners may prefer sound or repetition while others need quiet.', 'Clear language and a predictable sequence can reduce the friction of starting a lesson.', 'A speed measure alone cannot explain engagement, understanding, or effort.', 'Professional judgement and permission boundaries remain essential when interpreting learning needs.', 'Type2Learn follow-up: keep controls optional, test them with people, and record what changes.']],
      ['02', copy.teachers + ' 01', 'Ma’am Qurat', 'University lecturer · IT, ICT & computer science', 'teacher-workflow-mark.png', 'https://youtu.be/wfEO7Uv4Mio', copy.open, ['She begins a new topic by drawing out learners’ existing ideas before introducing the formal explanation.', 'Small-group discussion makes first thoughts visible, then gives learners a way to refine them together.', 'Practical demonstrations and multimedia can make unfamiliar technology more approachable.', 'When a whole class is stuck, basic tasks, presentations, and low-pressure checks can reconnect the concept.', 'Large classes, time pressure, limited devices, and unreliable internet all shape what support is realistic.', 'Her research paper, “Computer Based Method to Improve Spelling of a Learner with Dyslexia,” is a cited point of reference for this work.', 'She recommends clear fonts, repeated audio support, and short manageable study chunks where they help the learner.', 'She explicitly gave permission for the research to be cited with an accurate reference.']],
      ['03', copy.teachers + ' 02', 'Dr. Asjad', 'Biological Sciences academician · Virtual University', 'educator-insight-mark.png', 'https://github.com/Type2Learn/Interviews/blob/main/Professors/Pre-Product/Dr-Asjad-Virtual-University/Dr_Asjad_Virtual_University_Interview.md', copy.transcript, ['Complex biological processes need more than a definition: learners benefit from diagrams, discussion, and active participation.', 'A recurring challenge is memorising facts without being able to explain results or apply theory to a case.', 'Laboratory demonstrations, visual models, and case studies can strengthen conceptual understanding and retention.', 'Practical and case-based assessment can reveal understanding more accurately than memorisation alone.', 'When experimental techniques are difficult, simplified explanations, visual aids, and extra practice can help.', 'Large classes, limited laboratory time, and limited resources constrain the support a teacher can provide.', 'Virtual simulations, interactive sessions, and frequent formative checks may help address gaps in online learning.', 'He is open to a later review of whether Type2Learn addresses the learning challenges discussed.']],
      ['04', copy.teachers + ' 03', 'Ayesha Shah Muhammad', 'Visiting lecturer · social sciences and history', 'teacher-workflow-mark.png', 'https://github.com/Type2Learn/Interviews/blob/main/Professors/Pre-Product/Ayesha-Shah/ayesha_shah_professor_interview_round_one.md', copy.transcript, ['Participation matters: one-way delivery makes attention, retention, and application harder to sustain.', 'Clear, simple wording and everyday examples can make an unfamiliar concept easier to enter.', 'Small linked portions with pauses let a class check the current point before moving on.', 'Discussion, observation, article work, and current-scenario questions can operate within a lecture-led class.', 'Understanding can be evidenced through discussion, debate, verbal response, written work, and presentation.', 'Visual or multimedia material can make a new abstract topic more concrete and invite curiosity.', 'Flexibility in course content and equipped classrooms are necessary conditions for sustained adjustments.', 'Institutional support and reliable internet determine whether online learning is workable in practice.']]
    ];
  ...
  const studentVoiceSection = () => {
    const copy = isUrdu
      ...
      : { kicker: 'Learner voices', title: 'Five voices, one shared standard: people are never reduced to their identity.', body: 'This de-identified record keeps names, faces, private drafts, and identifying detail out of view. It shares only consent-aware learning themes, their relevance, and the design decision they should inform.', record: 'De-identified summary · source records are linked', notes: 'What the five contributions help us test', link: 'Open interview archive', temp: 'Open interview archive' };
    const students = isUrdu ? [
      ...
      ['01', 'Student 01', 'Focus and distraction record', 'https://github.com/Type2Learn/Interviews', copy.link], ['02', 'Student 02', 'Task initiation and typing record', 'https://github.com/Type2Learn/Interviews', copy.link], ['03', 'Student 03', 'Response format and sensory preference record', 'https://github.com/Type2Learn/Interviews', copy.link], ['04', 'Student 04', 'Reading and audio support record', 'https://github.com/Type2Learn/Interviews', copy.link], ['05', 'Student 05', 'Long-lecture and participation record', 'https://github.com/Type2Learn/Interviews', copy.link]
    ];
    const notes = isUrdu ? ['سوال کے الفاظ طالب علم کے لیے معنی رکھتے ہیں۔', 'اگلا قدم دکھائی دینا شروع کرنا آسان بناتا ہے۔', 'وقفہ اور واپسی کے لیے واضح اختیار ضروری ہے۔', 'مدد کو سیکھنے والے کے اختیار میں رہنا چاہیے۔', 'نجی کام کو عوامی نمونہ نہیں بنایا جائے گا۔', 'رفتار سے زیادہ سمجھ اور کوشش کا تناظر اہم ہے۔', 'طلبہ کی رائے کو مصنوعات کے فیصلے سے جوڑا جانا چاہیے۔', 'ہر عوامی اندراج میں اجازت کی سطح واضح ہوگی۔'] : ['Shorter sections can make a long reading task feel possible to begin and finish.', 'Animation and mascots help some learners, but can distract others; they must remain optional.', 'Typing can support recall for some learners, while others need more time, pauses, or a different response mode.', 'Sound preferences differ: silence, white noise, pink noise, and read-aloud cannot be assumed to work the same way for everyone.', 'Clear fonts, audio support, and visual explanation can reduce friction for learners who mix letters or find text difficult.', 'A familiar setting and preparation time can make a spoken response feel more manageable.', 'Guest access and sign-in should coexist so privacy and continuity are both possible.', 'Type2Learn decision: keep support controls learner-led, reversible, and separate from public identity.'];
  ...
  const communityReviewSection = () => {
    const copy = isUrdu
      ? { kicker: 'عمومی رائے', title: 'لوگوں نے کیا دیکھا، اور ہم نے اسے کیسے سنا۔', body: 'اب اس ریکارڈ میں 25 منفرد ویب سائٹ جائزوں کے اسکرین شاٹس شامل ہیں۔ ہر جائزے میں مثبت اشارے اور بہتر بنانے کی مفید بات شامل ہے؛ یہ کلینیکل یا تعلیمی توثیق کا دعویٰ نہیں۔', previous: 'پچھلا جائزہ', next: 'اگلا جائزہ', supplied: 'Type2Learn کے انٹرویو آرکائیو سے مصنوعات کا جائزہ', themes: 'اہم اشارے', archive: 'تمام انٹرویوز اور جائزوں کا آرکائیو کھولیں' }
      : { kicker: 'General reviews', title: 'What people noticed—and how we are listening.', body: 'This record now includes 25 distinct product-review screenshots. Each carries both a positive signal and a useful improvement point; none is presented as clinical or educational validation.', previous: 'Previous review', next: 'Next review', supplied: 'Product review from the Type2Learn interview archive', themes: 'What we are taking forward', archive: 'Open the complete interview and review archive' };
    // Source: github.com/Type2Learn/Interviews/revies. One alternate Reyan
    // capture is deliberately excluded so this remains 25 unique reviews.
    const reviewArchive = [
      ['ali-rehman-review.jpeg', 'Ali Rehman', '6 / 10', 'Explain the accessibility value through clearer feature guidance, examples, and visible learner outcomes.', 'علی رحمان', '6 / 10', 'رسائی کے فائدے کو واضح خصوصیات، مثالوں اور سیکھنے والے کے نتائج کے ذریعے زیادہ نمایاں کریں۔'],
      ['muhammad-taha-review.png', 'Muhammad Taha', 'General review', 'A clean, simple, engaging interface that makes typing practice feel useful.', 'محمد طٰہٰ', 'عمومی جائزہ', 'صاف، سادہ اور دل چسپ انٹرفیس جو ٹائپنگ کی مشق کو مفید بناتا ہے۔'],
      ['huzaifa-sharif-review.png', 'Huzaifa Sharif', 'General review', 'Improve the team story, course roadmap, mobile input behaviour, and unrealistic speed readings.', 'حذیفہ شریف', 'عمومی جائزہ', 'ٹیم کی پیش کش، کورس روڈمیپ، موبائل ان پٹ اور غیر حقیقی رفتار کی ریڈنگ بہتر کریں۔'],
      ['sami-review.jpeg', 'Sami', 'General review', 'Keep the minimalist, bilingual, practice-oriented approach clear and easy to use.', 'سامی', 'عمومی جائزہ', 'سادہ، دو لسانی اور مشق پر مبنی انداز کو واضح اور استعمال میں آسان رکھیں۔'],
      ['muhammad-zubair-review.jpeg', 'Muhammad Zubair', 'Learning-design signal', 'Typing mechanics can compete with understanding; keep comprehension-first and multiple response routes available.', 'محمد زبیر', 'سیکھنے کے ڈیزائن کا اشارہ', 'ٹائپنگ کی تکنیک سمجھنے کے ساتھ مقابلہ کر سکتی ہے؛ فہم کو پہلے اور متعدد جواب کے راستے دستیاب رکھیں۔'],
      ['maheen-ateeq-review.jpeg', 'Maheen Ateeq', 'General review', 'A supportive, understanding experience should remain flexible for varied neurodivergent needs.', 'ماہین عتیق', 'عمومی جائزہ', 'ایک معاون اور سمجھ دار تجربہ مختلف نیورو ڈائیورس ضرورتوں کے لیے لچک دار رہنا چاہیے۔'],
      ['muhammad-ali-imran-review.jpeg', 'Muhammad Ali Imran', '9 / 10', 'Keep customisation useful and continue collecting feedback from neurodivergent learners.', 'محمد علی عمران', '9 / 10', 'حسبِ ضرورت تبدیلی کو مفید رکھیں اور نیورو ڈائیورس سیکھنے والوں سے رائے لیتے رہیں۔'],
      ['miray-fatima-review.jpeg', 'Miray Fatima', 'General review', 'A clean interface and practical typing work, with room for continued refinement.', 'مرائے فاطمہ', 'عمومی جائزہ', 'صاف انٹرفیس اور عملی ٹائپنگ کے ساتھ مسلسل اصلاح کی گنجائش۔'],
      ['minahil-fatima-review.jpeg', 'Minahil Fatima', 'General review', 'The learning approach feels clear; information and navigation should become easier to find.', 'منہل فاطمہ', 'عمومی جائزہ', 'سیکھنے کا انداز واضح ہے؛ معلومات اور نیویگیشن کو زیادہ آسانی سے ملنا چاہیے۔'],
      ['muhammad-mahd-review.jpeg', 'Muhammad Mahd', 'General review', 'Plain language and a student-friendly presentation matter.', 'محمد مہد', 'عمومی جائزہ', 'سادہ زبان اور طالب علم دوست پیش کش اہم ہے۔'],
      ['taimoor-review.png', 'Taimoor', 'General review', 'The project’s purpose—helping people who need support—should stay visible.', 'تیمور', 'عمومی جائزہ', 'منصوبے کا مقصد، یعنی مدد کی ضرورت رکھنے والے لوگوں کی معاونت، واضح رہنا چاہیے۔'],
      ['ahmad-review.png', 'Ahmad', 'Usability signal', 'Make line wrapping and typing feedback stable at the end of a line.', 'احمد', 'استعمال کا اشارہ', 'لائن کے آخر میں ٹائپنگ کی لپیٹ اور رائے کو مستحکم بنائیں۔'],
      ['areeba-naeem-review.png', 'Areeba Naeem', 'Performance signal', 'Improve loading performance and make course-completion credentials clear.', 'عریبہ نعیم', 'کارکردگی کا اشارہ', 'لوڈنگ کی کارکردگی بہتر کریں اور کورس مکمل کرنے کے ثبوت کو واضح کریں۔'],
      ['bilal-nadeem-review.png', 'Bilal Nadeem', 'General review', 'The platform feels helpful for learning new things.', 'بلال ندیم', 'عمومی جائزہ', 'یہ پلیٹ فارم نئی چیزیں سیکھنے میں مددگار محسوس ہوتا ہے۔'],
      ['fawad-review.png', 'Fawad', 'Learning-design signal', 'Keep typing valuable without making it the only way to learn or respond.', 'فواد', 'سیکھنے کے ڈیزائن کا اشارہ', 'ٹائپنگ کو مفید رکھیں مگر اسے سیکھنے یا جواب دینے کا واحد راستہ نہ بنائیں۔'],
      ['saad-review.png', 'Saad', 'Performance signal', 'Improve landing-page scrolling, mascot loading, and the course roadmap.', 'سعد', 'کارکردگی کا اشارہ', 'لینڈنگ پیج اسکرولنگ، مسکوٹ لوڈنگ اور کورس روڈمیپ بہتر کریں۔'],
      ['abdur-rehman-review.jpeg', 'Abdur Rehman', 'General review', 'Keep quick access to lessons while refining visual detail and page transitions.', 'عبدالرحمان', 'عمومی جائزہ', 'سبق تک فوری رسائی برقرار رکھتے ہوئے بصری تفصیل اور صفحے کی تبدیلیاں بہتر کریں۔'],
      ['abubakar-review.jpeg', 'Abubakar', '7.5 / 10', 'A clean, functional experience can help neurodivergent children feel more comfortable learning.', 'ابوبکر', '7.5 / 10', 'صاف اور فعال تجربہ نیورو ڈائیورس بچوں کو سیکھتے وقت زیادہ آرام دہ محسوس کرا سکتا ہے۔'],
      ['hassan-mehboob-review.jpeg', 'Hassan Mehboob', 'Improvement signal', 'Refine design detail and graphics while keeping the central idea clear.', 'حسن محبوب', 'بہتری کا اشارہ', 'مرکزی خیال کو واضح رکھتے ہوئے ڈیزائن کی تفصیل اور گرافکس بہتر کریں۔'],
      ['reyan-review.jpeg', 'Reyan', '7 / 10', 'Improve first-visit explanation, alignment, and visual polish without losing the lightweight feel.', 'ریان', '7 / 10', 'ہلکے پن کو برقرار رکھتے ہوئے پہلی بار کے تعارف، ترتیب اور بصری نفاست کو بہتر کریں۔'],
      ['muneeb-review.jpeg', 'Muneeb', '8 / 10', 'Keep the clean, engaging approach and prioritise small mobile UI fixes.', 'منیب', '8 / 10', 'صاف اور دل چسپ انداز برقرار رکھیں اور چھوٹی موبائل UI اصلاحات کو ترجیح دیں۔'],
      ['obaida-nadeem-review.jpeg', 'Obaida Nadeem', 'General review', 'Accessible presentation and support for neurodivergent learners are worth carrying forward.', 'عبیدہ ندیم', 'عمومی جائزہ', 'قابلِ رسائی پیش کش اور نیورو ڈائیورس سیکھنے والوں کے لیے مدد کو آگے بڑھانا اہم ہے۔'],
      ['omair-review.jpeg', 'Omair', '8 / 10', 'Accessible tools, a real-world purpose, and a straightforward layout matter.', 'عمیر', '8 / 10', 'قابلِ رسائی اوزار، حقیقی مقصد اور سیدھی ترتیب اہم ہیں۔'],
      ['rehan-review.jpeg', 'Rehan', 'General review', 'The neurodivergent-learner focus and the team’s thoughtful effort are meaningful.', 'ریحان', 'عمومی جائزہ', 'نیورو ڈائیورس سیکھنے والوں پر توجہ اور ٹیم کی سوچ سمجھ کر کی گئی کوشش اہم ہے۔'],
      ['talha-aziz-review.jpeg', 'Talha Aziz', 'General review', 'Preserve guest access, refine controls and dashboards, and explain the accessibility value more clearly.', 'طلحہ عزیز', 'عمومی جائزہ', 'مہمان رسائی برقرار رکھیں، کنٹرول اور ڈیش بورڈ بہتر کریں، اور رسائی کے فائدے کو زیادہ واضح بیان کریں۔']
    ];
    const reviews = reviewArchive.map((review) => isUrdu ? [review[0], review[4], review[5], review[6]] : review.slice(0, 4));
    return '<section class="page-section community-review-section" id="community-reviews"><div class="content-wrap"><div class="section-heading"><div class="section-heading-copy"><p class="section-kicker">' + copy.kicker + '</p><h2>' + copy.title + '</h2><p>' + copy.body + '</p></div>' + status(isUrdu ? 'سننے کا ریکارڈ' : 'Listening record', 'blue') + '</div><div class="review-carousel" data-review-carousel aria-roledescription="carousel"><div class="review-viewport"><div class="review-track">' + reviews.map((review, index) => '<article class="review-slide" data-review-slide role="group" aria-roledescription="slide" aria-label="' + (index + 1) + ' / ' + reviews.length + '"><div class="review-screenshot"><img src="/assets/community-reviews/' + review[0] + '" alt="' + copy.supplied + ' from ' + review[1] + '" loading="lazy"></div><div class="review-copy"><p class="section-kicker">' + copy.supplied + '</p><h3>' + review[1] + '</h3><span class="review-rating">' + review[2] + '</span><p class="review-theme-label">' + copy.themes + '</p><p class="review-theme">' + review[3] + '</p></div></article>').join('') + '</div></div><div class="review-carousel-controls"><button class="carousel-arrow" type="button" data-review-previous aria-label="' + copy.previous + '"><span aria-hidden="true">←</span></button><p><span data-review-position>1</span> / ' + reviews.length + '</p><button class="carousel-arrow" type="button" data-review-next aria-label="' + copy.next + '"><span aria-hidden="true">→</span></button></div><a class="interview-video-link review-archive-link" href="https://github.com/Type2Learn/Interviews/tree/main/revies" target="_blank" rel="noopener noreferrer">' + copy.archive + ' <span aria-hidden="true">↗</span></a></div></div></section>';
  };
  ...
  const urduParticipationTrust = () => shell(
    pageHero('شرکت اور اعتماد', 'شرکت سے کام بدلنا چاہیے۔ اعتماد صاف نظر آنا چاہیے۔', 'یہ مشترکہ ڈیزائن، پیشہ ورانہ رائے، کمیونٹی کی شرکت، رسائی، رازداری، سکیورٹی اور مدد کی حدود کا واحد عوامی ریکارڈ ہے۔', 'موجودہ حیثیت', 'عوامی ریکارڈ میں اس وقت ایک پیشہ ور، تین پروفیسر انٹرویوز، پانچ سیکھنے والوں کے ریکارڈ اور 25 منفرد مصنوعات کے جائزوں کے اسکرین شاٹس شامل ہیں۔ طبی توثیق یا حمایت کا دعویٰ نہیں کیا جاتا۔') +
    ...
    '<section class="page-section is-pale evidence-placement-section" id="video-conversations"><div class="content-wrap"><div class="evidence-placement-grid"><div><p class="section-kicker">شواہد اور ویڈیو گفتگو</p><h2>سجاوٹی تعریفوں کے لیے نہیں، اجازت کے ساتھ ثبوت کے لیے تیار۔</h2><p>شائع شدہ گفتگو کارڈ ان عوامی اصل ریکارڈز سے جڑے ہیں جو اس وقت دستیاب ہیں۔ متن، آڈیو، نقل اور منظور شدہ ویڈیو برابر اہم شراکتیں ہیں؛ کسی شریک کی تصویر ضروری نہیں۔</p><ol class="evidence-steps"><li><span>01</span>سوال اور مواد کی شکل بتائیں۔</li><li><span>02</span>اجازت کی سطح اور تاریخ درج کریں۔</li><li><span>03</span>ویڈیو، آڈیو یا متن کا ریکارڈ جوڑیں۔</li><li><span>04</span>جو بدلا اور جو کھلا ہے، شائع کریں۔</li></ol></div><aside class="evidence-media-slot" data-evidence-media aria-label="Type2Learn کا عوامی انٹرویو اور جائزہ آرکائیو"><span>' + icon('message') + '</span><p>عوامی اصل آرکائیو</p><strong><a href="https://github.com/Type2Learn/Interviews" target="_blank" rel="noopener noreferrer">انٹرویوز اور جائزے کھولیں <span aria-hidden="true">↗</span></a></strong><small>اصل ریکارڈ صرف اس صورت میں شائع کیے جاتے ہیں جب متعلقہ اجازت اور جائزے کی شرائط پوری ہوں۔</small></aside></div></div></section>' +
  ...
  const teamDeck = () => {
    const members = [
      ['Muhammad Taha Bin Zaeem', 'Founder · Development Lead', '/assets/team/founder-muhammad-taha.webp', 'Muhammad Taha Bin Zaeem, Founder and Development Lead of Type2Learn', 'supplied', 'He leads Type2Learn’s vision, product development, partnerships, and responsible growth—connecting the learning experience to clear standards for evidence, privacy, accessibility, and learner dignity.', 'Learning technology should make the next meaningful action clearer without making a learner smaller.', ['Vision & strategy', 'Product development', 'Responsible growth']],
      ...
      if (interviewRecord && !document.getElementById('professional-interview')) {
        ...
        if (professionalCard) {
          ...
          professionalSection.innerHTML = isUrdu
            ...
            : '<div class="content-wrap"><div class="section-heading"><div class="section-heading-copy"><p class="section-kicker">Professional interview</p><h2>One professional. One complete, permission-aware record.</h2><p>Dr. Mayda’s full interview and a concise, consent-aware summary sit together here. The summary keeps the learning implications in view without presenting a diagnosis or a testimonial claim.</p></div>' + status('Permission-aware', 'teal') + '</div><div class="professional-interview-stage"></div></div>';
  ...
  const setupAuthExperience = () => {
    ...
    if (googleButton && !document.querySelector('.auth-google-terms')) {
      googleButton.insertAdjacentHTML('afterend', '<p class="auth-google-terms">By continuing with Google, you acknowledge the current <a href="/privacy/">privacy notice</a> and <a href="/terms/">preview terms</a>. They are not a final school or consumer contract.</p>');
    }
    const previewTerms = document.querySelector('.auth-terms-check span:last-child');
    if (previewTerms) previewTerms.innerHTML = 'I have read the current <a href="/privacy/">privacy notice</a> and <a href="/terms/">preview terms</a>. These preview documents are not a final school or consumer contract.';
