...
const metricsFor = (value = {}) => ({
  ...
  readingSectionMoves: boundedNumber(value.readingSectionMoves, 200),
  readingSectionBacktracks: boundedNumber(value.readingSectionBacktracks, 100),
  ...
  typingPauseTotalMs: boundedNumber(value.typingPauseTotalMs, 30 * 60 * 1000),
  typingBursts: boundedNumber(value.typingBursts, 12000),
  typingFocusReturns: boundedNumber(value.typingFocusReturns, 200),
  taskFocusChanges: boundedNumber(value.taskFocusChanges, 500),
  taskFocusReturns: boundedNumber(value.taskFocusReturns, 200),
  controlActivations: boundedNumber(value.controlActivations, 1000),
  scrollMoves: boundedNumber(value.scrollMoves, 1000),
  scrollBacktracks: boundedNumber(value.scrollBacktracks, 500),
  maxScrollDepth: boundedNumber(value.maxScrollDepth, 100),
  viewportChanges: boundedNumber(value.viewportChanges, 100),
  ttsStarts: boundedNumber(value.ttsStarts, 100),
  ttsCompleted: boundedNumber(value.ttsCompleted, 100),
  ttsPauses: boundedNumber(value.ttsPauses, 100),
